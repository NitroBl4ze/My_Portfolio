...
const Portfolio = () => {
  ...
  const handleDownloadResume = () => {
    ...
    link.download = 'Aditya_Ram_Resume.pdf';
    link.click();
  };

  const handleViewReport = (reportType: string) => {
    // Handle PDF report viewing - replace with actual file paths
    console.log(`Opening ${reportType} report`);
    // You can replace this with actual PDF file paths
    window.open('#', '_blank');
  };

  const handleViewProject = (projectName: string) => {
    // Handle project viewing - replace with actual project URLs
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {[
              ...
              <Card key={index} className="bg-white/10 backdrop-blur-lg border-white/20 text-white hover:bg-white/20 transition-all duration-300 hover:scale-105 animate-scale-in">
                <CardHeader>
